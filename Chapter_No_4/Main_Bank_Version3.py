# Test the program using accounts
...
print("Accouont number for Joe is:", joesAccountNumber)
nextAccountNumber = nextAccountNumber + 1

oAccount = Account("Mary", 12345, "MarPassword")
...
# Call some methods of the two accounts
...
uesrBalance = accountsDict[newAccountNumber].getBalance(userPassword)
print()
